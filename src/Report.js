  ...
  return <div className='report'>
    <div className='report-top'>
      ...
      <div className='float-right graph-controls'>
        <label>
          <input type='checkbox' onClick={(e) => props.toggleGraphLine('consumption')} />
          Power consumption
        </label>
        <label>
          <input type='checkbox' onClick={(e) => props.toggleGraphLine('generation')} />
          Power generation
        </label>
        <label>
          <input type='checkbox' onClick={(e) => props.toggleGraphLine('batteryCharge')} />
          Battery charge
        </label>
      </div>
    </div>
